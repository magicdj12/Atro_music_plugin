...
__MODULE__ = "خرید نمایندگی◉"
__HELP__ = """

◉قوانین خرید نمایندگی

1-اولین قانون برای دریافت نمایندگی تیم أترو سابقه کاری هست.

2-دومین قانون برای دریافت نمایندگی ارسال احراز هویت است 
